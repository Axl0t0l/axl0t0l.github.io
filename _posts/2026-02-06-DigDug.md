...
## Solution Approach
### Recon
Always start with nmap scan, since we're looking for DNS server we should use ```-sU``` flag so its ```bash
nmap -sC -sU -p 50-100 MACHINE_IP```
![](/assets/img/posts/2026-02-06-DigDug/nmap.png){: w="800" }
> [!NOTE]
...
and Tatadaa!
![](assets/img/posts/2026-02-06-DigDug/nslookup.png){: w="800" }
